...
const ACTIONS: Array<NavigationItem> = [
	...
	},
	{
		...
		icon: <Icon className="mr-3" icon="feather:arrow" />,
		text: 'Snapchat',
	},
];
...
export default function HomePage(): JSX.Element {
	...
	const birthday = new Date('2000-12-09');
	const isBirthday =
		today.getDate() === birthday.getDate() && today.getMonth() === birthday.getMonth();

	const description = `I am a senior med student and a future resident Doctor`;
			...
			<div className="min-h-screen flex items-center justify-center py-12">
				<div className="max-w-md sm:max-w-lg md:sm:max-w-2xl lg:sm:max-w-3xl w-full space-y-8 text-center">
					<Animate
						...
						I&apos;m Rithvika, <br className="hidden sm:block" />a{' '}
						<Pill.Standard className="mt-4">Doctor</Pill.Standard>
					</Animate>
